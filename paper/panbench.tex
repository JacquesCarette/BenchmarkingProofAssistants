...
\chez\todo{Reed: cite chez here} as a runtime, which incurs a high interpreter startup cost.
...
let bindings. \todo[inline]{Reed: sent Edwin the reproducer, waiting for a response.}
...
45 seconds to typecheck 4096 of them. This is a consequence of the decision to
not use a more optimized representation of \texttt{nat} internally.
