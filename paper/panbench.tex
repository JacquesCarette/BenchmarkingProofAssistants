...
\begin{figure}[h]
\begin{minipage}{0.50\textwidth}
\scalebox{0.75}{\input{pgfs/NestedLetXors/user}}
\end{minipage}
\begin{minipage}{0.50\textwidth}
\scalebox{0.75}{\input{pgfs/NestedLetXors/rss}}
\end{minipage}
...
use \chez\todo{Reed: cite chez here} as a runtime, which incurs a high interpreter startup cost.
