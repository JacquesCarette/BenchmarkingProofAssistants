...
Note that we uniformly report all results in alphabetical order of the system's names.
...
\todo{JC: Reed, please fill-in X and Y below.}
When we report times, we report X. We also report ``max RSS'' (maximum
resident set size) as given by Y.

\section{Results}
\label{sec:results}

\todo{JC: I say 32 tests here, table has 30. Which one is wrong?}
...
\idris & 0.58 (0.007) & 0.1 (0.007)  & 248 (0.1) \\
