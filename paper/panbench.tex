...
% - system time variance hard to explain
%
% --------------
% Empty
...
%
% all systems get worse, following a similar path, except that Agda gets significantly
% worse at n=128; oddly lean and idris2 plateau?
% 
% LargeIndexedDatatype
% 
% - all systems get worse, although idris2 is impressively 'flat' until n=16
% - lean is remarkable by its much lower memory use
%
...
% NestedLet
% 
% - again, massive time spike for idris2, rest gently slop up
% - memory starting to rise
%
% * another notch?
%
% NestedLetAdditions
% 
% - unexplained plateau in agda and irdris2, flat rocq, gently sloping lean
% - (dynload GMP?)
%
% NestedLetFunctions
% 
...
% IdChain
%
% - all systems blow up (seems driven by memory use) between 8 and 16
